...
<head>
    ...
    <title>Tamilnadu Books - Admin</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ route('admin_dashboard') }}"><img src="{{ asset('/admin/img/logo.png') }}">Tamilnadu Books - Admin</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="javascript:void(0)"><i class="fa fa-bar-chart-o fa-fw"></i> Category<span class="fa arrow"></span></a>

                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{ route('admin_list_category') }}">List all categories</a>
                                </li>
                                <li>
                                    <a href="{{ route('admin_add_new_category') }}">Add new category</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <a href="javascript:void(0)"><i class="fa fa-bar-chart-o fa-fw"></i> Book type<span class="fa arrow"></span></a>

                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{ route('admin_list_book_type') }}">List all Book types</a>
                                </li>
                                <li>
                                    <a href="{{ route('admin_add_new_book_type') }}">Add new Book type</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <a href="javascript:void(0)"><i class="fa fa-book fa-fw"></i> Book<span class="fa arrow"></span></a>

                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{{ route('admin_list_book') }}">List all books</a>
                                </li>
                                <li>
                                    <a href="{{ route('admin_add_new_book') }}">Add new book</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
