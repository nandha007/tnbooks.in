...
<div id="home">
  <div id="home-slider" class="carousel slide carousel-fade" data-ride="carousel">
	...
	<div class="carousel-inner">
	  <div class="item active" style="background: url(img/tn_book_varities.jpg);">
		<div class="container">
		  <div class="row">
			<div class="col-md-12">
			  <div class="carousel-content">
				<h3 class="animated fadeInLeftBig text-center">We have as many collections of books as these many colors...</h3>
	  ...
	  <!-- <div class="item" style="background: url(img/img01.jpg);">
		<div class="container">
		  <div class="row">
			<div class="col-md-12">
			  <div class="carousel-content">
